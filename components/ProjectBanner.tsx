    ...
    >
      ...
      <div className="absolute top-1/2 -translate-y-1/2 left-0 w-full overflow-hidden opacity-10 select-none pointer-events-none">
        <motion.div
          ...
          className="whitespace-nowrap flex gap-16 text-[12vw] leading-none font-clash font-black text-white"
        >
          <span>IDEAS → PROTOTYPES → PRODUCTS</span>
          <span>IDEAS → PROTOTYPES → PRODUCTS</span>
          <span>IDEAS → PROTOTYPES → PRODUCTS</span>
        </motion.div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10 flex flex-col md:flex-row items-center justify-between gap-10">
        ...
        <div className="text-left relative">
          <div className="flex items-center gap-2 mb-4">
            ...
            <span className="text-india-saffron font-bold tracking-[0.2em] text-xs uppercase">
              Prototype to Product
            </span>
          </div>

          <h2 className="text-5xl md:text-6xl font-clash font-bold text-white leading-[0.95]">
          ...
          <p className="text-gray-400 font-medium max-w-lg mt-4 text-lg">
            I take raw ideas, build fast prototypes, and ship products people can actually use.
          </p>
        </div>
      ...
      {/* Decorative Glow */}
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[500px] h-[500px] bg-india-saffron/20 rounded-full blur-[100px] pointer-events-none" />
    </section>
  );
};
